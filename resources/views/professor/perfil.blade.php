...
@section('header')
<i class="fas fa-user fa-fw mr-2"></i> Perfil <i class="fas fa-angle-right fa-fw"></i> Visualizar
@endsection
    ...
    <div class="row p-3 text-center">
        ...
        @if(Auth::user()->image)
            <div class="circle img-perfil">
                ​<img src="{{ asset('storage/perfil/professores/' . Auth::user()->image) }}" alt="imagem do perfil">
            </div>
        @else
            <div class="circle img-perfil">
